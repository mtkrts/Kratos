...
void AddProcesses(pybind11::module& m)
{
    ...
    class_<TrilinosSpAlModelType, TrilinosSpAlModelType::Pointer, BaseSpAlModelType >(m,"TrilinosSpalartAllmarasTurbulenceModel")
    ...
    class_<BaseStokesInitializationType, BaseStokesInitializationType::Pointer, Process>(m, "TrilinosBaseStokesInitialization")
    ...
    class_<TrilinosStokesInitializationType, TrilinosStokesInitializationType::Pointer, BaseStokesInitializationType >(m,"TrilinosStokesInitializationProcess")
    ...
    class_<TrilinosDistanceCalculationType2D, TrilinosDistanceCalculationType2D::Pointer, BaseDistanceCalculationType2D >(m,"TrilinosVariationalDistanceCalculationProcess2D")
    ...
    class_<TrilinosDistanceCalculationType3D, TrilinosDistanceCalculationType3D::Pointer, BaseDistanceCalculationType3D >(m,"TrilinosVariationalDistanceCalculationProcess3D")
        .def(init<Epetra_MpiComm&, ModelPart&, TrilinosLinearSolverType::Pointer, unsigned int>())
        ;
    ...
    class_<BaseLevelSetConvectionProcess2D, BaseLevelSetConvectionProcess2D::Pointer, Process>(m,"BaseTrilinosLevelSetConvectionProcess2D");
    class_<BaseLevelSetConvectionProcess3D, BaseLevelSetConvectionProcess3D::Pointer, Process>(m,"BaseTrilinosLevelSetConvectionProcess3D");
    ...
    class_<TrilinosLevelSetConvectionProcess2D, TrilinosLevelSetConvectionProcess2D::Pointer, BaseLevelSetConvectionProcess2D>(m, "TrilinosLevelSetConvectionProcess2D")
        .def(init<Epetra_MpiComm&, Variable<double>&, ModelPart&, TrilinosLinearSolverType::Pointer>())
    ...
    class_<TrilinosLevelSetConvectionProcess3D, TrilinosLevelSetConvectionProcess3D::Pointer, BaseLevelSetConvectionProcess3D>(m, "TrilinosLevelSetConvectionProcess3D")
        .def(init<Epetra_MpiComm&, Variable<double>&, ModelPart&, TrilinosLinearSolverType::Pointer>())
        .def(init<Epetra_MpiComm&, Variable<double>&, ModelPart&, TrilinosLinearSolverType::Pointer, const double>())
        .def(init<Epetra_MpiComm&, Variable<double>&, ModelPart&, TrilinosLinearSolverType::Pointer, const double, const double>())
        .def(init<Epetra_MpiComm&, Variable<double>&, ModelPart&, TrilinosLinearSolverType::Pointer, const double, const double, const unsigned int>())
